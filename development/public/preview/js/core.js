// initiate particles
particlesJS.load('particles-js', "js/particles_parameters.json", function () {
...
var my_autoComplete = new autoComplete({
    ...
    source: function (term, suggest) {
        ...
        var choices = Object.keys(faqJSONs);
        var matches = [];
    ...
    onSelect: function (e, term, item) {
        ...
        document.getElementById('faqResponse').innerHTML = faqJSONs[key];
...
function processSponsors(resp) {
    ...
    sponsorContainer = document.getElementById('sponsor-base')
